...
public class MarkerClusterDemo extends Activity implements OnMapLoadedCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBaiduMap.setOnMarkerClickListener(new BaiduMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                Toast.makeText(MarkerClusterDemo.this, "点击了", Toast.LENGTH_SHORT).show();
                return false;
            }
        });
        // 添加Marker点
    ...
    public void addMarkers() {
        ...
        LatLng l1H = new LatLng(39.096548,117.204693);
        LatLng l1I = new LatLng(39.261223,117.117306);
        LatLng l1J = new LatLng(39.270162,117.235738);
        ...
        items1.add(new MyItem(l1H));
        items1.add(new MyItem(l1I));
        items1.add(new MyItem(l1J));
    ...
    public class MyItem implements ClusterItem {
        ...
        public BitmapDescriptor getBitmapDescriptor() {
            ...
            LayoutInflater factorys = LayoutInflater.from(MarkerClusterDemo.this);
